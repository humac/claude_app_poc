...
export default function EditUserDialog({ user, onClose, onUserUpdated }) {
  ...
  return (
    <Dialog open={!!user} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="glass-overlay max-w-[95vw] sm:max-w-[600px]">
        <DialogHeader>
        ...
        <div className="space-y-4 py-2">
          <div className="glass-panel rounded-xl p-4 space-y-4">
            <h3 className="caption-label">User Information</h3>
          ...
          <div className="glass-panel rounded-xl p-4 space-y-4">
            <h3 className="caption-label">Manager Information</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
        ...
        <DialogFooter className="flex-col-reverse sm:flex-row gap-2">
          <Button variant="outline" onClick={onClose} className="w-full sm:w-auto btn-interactive">Cancel</Button>
          <Button onClick={handleSubmit} disabled={saving} className="w-full sm:w-auto btn-interactive">
